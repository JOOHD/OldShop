...
<body>
                ...
                <div class="admin_content_wrap">
                 ...
                 <!-- Criteria(pageNum, amount, keyword) 데이터를 저장하고 있는 기존의 <form> 태그를 
                	 그대로 남겨 두었다. authorModify.jsp 에서 다시 authorDetail.jsp 이동을 할 수 있도록 설계,
                	 authorDetail.jsp 로 이동할 경우 Criteria 데이터가 필요하기 때문이다. -->
